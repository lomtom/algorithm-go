...
import { humanize, plainify,markdownify, slugify } from "@/lib/utils/textConverter";
            ...
            searchResults?.map(({ item }, index) => (
              <div className="mb-12 md:col-6 lg:col-4" key={`search-${index}`}>
                <div className="bg-body dark:bg-darkmode-body">
                  ...
                  <p className="mb-6" dangerouslySetInnerHTML={{ __html:markdownify(plainify(item.content?.slice(0, Number(summary_length))))}}>
                  </p>
                  <a
